...
export function AboutUsSection() {
  return (
    ...
    < Section id="about"
      ...
      >
        <div
          className="flex flex-col lg:flex-row justify-between items-center gap-12 lg:gap-20 mb-4"
        >
          ...
          <Glow
            ...
            glowSize={100}>
            <Video
              url="https://vimeo.com/1056158654"
              isClickable={true}
              showControls={true}
              aspectRatio={16 / 9}
            />
        ...
        <div className="hidden lg:flex space-x-[16px]">
          <Video
            url='https://vimeo.com/1056153863'
            isClickable={true}
            showControls={true}
          />
          <Video
            url='https://vimeo.com/1137398062'
            isClickable={true}
            showControls={true}
          />
        </div>
