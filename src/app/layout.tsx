        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `
             ...
             style.textContent='form:has(input[type="email" i]),
             form:has(input[name="email" i]),
             .hs-form-iframe{position:relative!important}
             form:has(input[type="email" i])::before,
             form:has(input[name="email" i])::before,
             .hs-form-iframe::before{
             content:"";
             position:absolute;
             inset:0;
             display:flex;
             ...
             try{window.ApolloInbound.formEnrichment.init({
             appId: '696de53b0fb051001d35de5e',
